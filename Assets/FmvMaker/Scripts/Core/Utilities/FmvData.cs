...
namespace FmvMaker.Core.Utilities {
    public static class FmvData {
        ...
        public static ClickableModel[] GenerateItemDataFromLocalFile() {
            return JsonUtility.FromJson<ClickableModelWrapper>(ResourceVideoInfo.ClickableModelData.text).ItemList;
        }
