...
namespace FmvMaker.Graph {
    [UnitTitle("On Fmv Video Skipped")]
    [UnitCategory("Events\\FmvMaker")]
    public class OnFmvVideoSkipped : EventUnit<FmvGraphElementData> {
        ...
        public override EventHook GetHook(GraphReference reference) {
            return new EventHook(FmvGraphEventNames.OnFmvVideoSkipped);
        }
        ...
        public static void Trigger(FmvGraphElementData eventData) {
            EventBus.Trigger(FmvGraphEventNames.OnFmvVideoSkipped, eventData);
        }
    }
}