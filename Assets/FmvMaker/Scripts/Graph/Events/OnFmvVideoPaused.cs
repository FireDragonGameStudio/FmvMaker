...
namespace FmvMaker.Graph {
    [UnitTitle("On Fmv Video Paused")]
    [UnitCategory("Events\\FmvMaker")]
    public class OnFmvVideoPaused : EventUnit<FmvGraphElementData> {
        ...
        public override EventHook GetHook(GraphReference reference) {
            return new EventHook(FmvGraphEventNames.OnFmvVideoPaused);
        }
        ...
        public static void Trigger(FmvGraphElementData eventData) {
            EventBus.Trigger(FmvGraphEventNames.OnFmvVideoPaused, eventData);
        }
    }
}