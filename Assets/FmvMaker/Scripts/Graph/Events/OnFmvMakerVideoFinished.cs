...
namespace FmvMaker.Graph {
    [UnitTitle("On FmvMaker Video Finished")]
    [UnitCategory("Events\\FmvMaker")]
    public class OnFmvMakerVideoFinished : EventUnit<FmvGraphElementData> {
        ...
        public override EventHook GetHook(GraphReference reference) {
            return new EventHook(FmvMakerGraphEventNames.OnFmvMakerVideoFinished);
        }
