...
namespace FmvMaker.Graph {
    [UnitTitle("On Fmv Video Finished")]
    [UnitCategory("Events\\FmvMaker")]
    public class OnFmvVideoFinished : EventUnit<FmvGraphElementData> {
        ...
        public override EventHook GetHook(GraphReference reference) {
            return new EventHook(FmvGraphEventNames.OnFmvVideoFinished);
        }
        ...
        public static void Trigger(FmvGraphElementData eventData) {
            EventBus.Trigger(FmvGraphEventNames.OnFmvVideoFinished, eventData);
        }
    }
}